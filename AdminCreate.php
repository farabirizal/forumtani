    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Create</div>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="background-color: #F8F8F8;">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Image -->
                    <div class="container">
                        <form action="tambah.php" method="post" enctype="multipart/form-data" id="myForm">
                            <div class="row">
                                <div class="col-sm-4">
                    ...
                    <div class="form-group row" style="margin-top: 20px;">
                        ...
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-nama" name="nama">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-desa" class="col-2 col-form-label label-input">Desa</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-desa" name="desa">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-alamat" class="col-2 col-form-label label-input">Alamat</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-alamat" name="alamat">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-ttl" class="col-2 col-form-label label-input">TTL</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-ttl" name="ttl">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-nik" class="col-2 col-form-label label-input">No NIK</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-nama" name="nik">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-ibu" class="col-2 col-form-label label-input">Ibu Kandung</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-ibu" name="ibu">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-komoditas" class="col-2 col-form-label label-input">Komoditas</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-komoditas" name="komoditas">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-luas" class="col-2 col-form-label label-input">Luas Lahan</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-luas" name="luas_lahan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-sebagai" class="col-2 col-form-label label-input">Sebagai</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-sebagai" name="status">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="input-hp" class="col-2 col-form-label label-input">No HP</label>
                        <div class="col-10">
                            <input class="form-control input-data" type="text" id="input-hp" name="no_hp">
                        </div>
                    </div>
                    </form>
                    <!-- End Container Text -->
